...
export default {
  ...
  methods: {
    ...
    async initialWithSearch(search,from,to) {
      this.$store.commit('showHideLoading',true);
      var response = await TourService.getPromotePackageBySearch(search,from,to);
      this.tourlist = response.data;
      this.$store.commit('showHideLoading',false);
    },
    async initialWithCity(city) {
      this.$store.commit('showHideLoading',true);
      var response = await TourService.getPromotePackageByCity(city);
      this.tourlist = response.data;
      this.$store.commit('showHideLoading',false);
    },
    nextPage() {
