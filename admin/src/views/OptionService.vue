              ...
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md4>
                  <v-text-field required
                    :rules="[() => editedItem.optionServiceId.length > 0 || 'Required field']"
                     v-model="editedItem.optionServiceId" label="optionServiceId"></v-text-field>
                </v-flex>
                <v-flex xs12 sm6 md4>
    ...
    <v-data-table :headers="headers" :items="optionService" class="elevation-1">
      <template v-slot:items="props">
        <tr class="ellip-text">
          ...
          <td>{{ props.item.optionServiceId }}</td>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "optionServiceId",
        align: "center",
        sortable: false,
        value: "optionServiceId"
      },
      { text: "optionServiceName", align: "center", value: "optionServiceName" },
