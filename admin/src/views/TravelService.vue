          ...
          <v-card-text>
            ...
            <v-container grid-list-xl>
              <v-layout wrap>
                ...
                <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.travelServiceName" label="TravelServiceName"></v-text-field>
                </v-flex>
                 <v-flex xs12 sm6 md4>
                  <v-text-field v-model="editedItem.travelServiceNameEN" label="TravelServiceNameEN"></v-text-field>
                </v-flex>
                <v-flex xs12 sm6 md4>
                  <v-select
